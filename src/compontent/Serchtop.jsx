...
class Serchtop extends Component {
    componentDidMount(){
        var s=function(){
    ...
    render() {
        ...
        return (
            <div>
                <div className="topssbox1">
                    <div className="topss">
                        <NavLink exact to={{ pathname: '/seacher' }} onClick={() => { window.location.replace('http://localhost:3000/seacher') }}>
                            <div class="topssbox">
                ...
                <div className="banner">
                    <div id="fade_focus">
                        ...
                        <ul>
                            <li><img src={require('../static/images' + '/b1.jpg')} /></li>
                            <li><img src={require('../static/images' + '/b2.jpg')} /></li>
                        </ul>
                    </div>
                </div>
            </div>
